...
namespace Characters
{
    public class ShipController : NetworkMovableObject
    {
        ...
        protected override void HasAuthorityMovement()
        {
            ...
            var faster = isFaster ? spaceShipSettings.Faster : 1.0f; _shipSpeed = Mathf.Lerp(_shipSpeed, speed * faster, SettingsContainer.Instance.SpaceShipSettings.Acceleration);
        ...
        public void OnTriggerEnter(Collider other)
        {
            ...
            RpcChangePosition(new Vector3(100, 0, 100));
